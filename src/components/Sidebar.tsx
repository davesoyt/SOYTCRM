...
import { Users, Building2, TrendingUp, GitBranch, LayoutDashboard, Upload, Filter, CheckSquare, UserCircle, Settings, Box, ClipboardList, LayoutGrid, Send, ChevronDown, ChevronRight, Database } from 'lucide-react'
